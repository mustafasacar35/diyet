...
import { Plus, Trash2, Pencil, Check, X, GripHorizontal } from "lucide-react"
...
export function PatientProfileDialog({
    ...
    async function loadPatientData() {
        ...
        const { data, error } = await supabase
            .from("patients")
            .select("full_name, birth_date, height, weight, gender, activity_level, liked_foods, disliked_foods, phone, patient_goals, program_template_id, visibility_settings, macro_target_mode, preferences")
            .eq("id", patientId)
            .single()
