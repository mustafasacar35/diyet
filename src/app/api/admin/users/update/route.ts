...
export async function POST(request: Request) {
    try {
        ...
        const { target_user_id, new_email, new_password, full_name, title, max_devices, valid_until } = body
        ...
        if (valid_until !== undefined) profileUpdates.valid_until = valid_until
