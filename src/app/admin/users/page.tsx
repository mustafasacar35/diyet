                ...
                <Table>
                    ...
                    <TableBody>
                        {isLoadingData ? (
                            ...
                            <TableRow>
                                <TableCell colSpan={5} className="h-24 text-center text-gray-500">Kullanıcı bulunamadı.</TableCell>
                            </TableRow>
                        ) : (
                            users.map((user) => (
                                <TableRow key={user.id}>
                                    ...
                                    <TableCell>
                                        <div className="flex flex-col gap-1">
                                            ...
                                            {/* Show device count if available (requires joining with user_devices, assuming backend view handles it or we fetch separate) */}
                                            {/* For now we just show the reset button, as showing count requires heavy query or view update */}
                                        </div>
                                    </TableCell>
