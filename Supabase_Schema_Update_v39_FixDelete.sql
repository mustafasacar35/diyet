-- v39: FIX GROUP DELETION (MANUAL CASCADE) & ENSURE PERMISSIONS

-- 1. ROBUST DELETE GROUP FUNCTION
-- Explicitly deletes dependencies to avoid Foreign Key errors if CASCADE is missing
...
-- 2. ENSURE ADD MEMBER WORKS (Re-apply v38 logic just in case)
